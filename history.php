...
<?php
    ...
    $orders = orderHistory($_SESSION["user"]["Email"]);
...
<main>
    ...
    <link rel="stylesheet" type="text/css" href="css/history-util.css">
    <nav class="navbar">
        <div class="logo">
            <div class="logo-left">
    ...
    <div class="padding-profile"></div>
    <header class="main-head">
        <nav class="head-nav">
            <ul class="menu">
                <li>
                    <a href="profile.php">
                        <img src="assets/profile.png" alt=""><span>Profile</span></a>
                </li>
                <li>
                    <a href="billing.php">
                        <img src="assets/billing.png" alt=""><span>Billing Info</span></a>
                </li>
                <li>
                    <a href="history.php">
                        <img style="margin-left: 18px;  " src="assets/order-history.png" alt=""><span>Order
                            History</span></a>
                </li>
                <li>
                    <a href="logout.php">
                        <img class="logout" style="margin-left: 22px; margin-right:38px;" src="assets/logout.png" alt=""><span>Logout</span></a>
                </li>
            </ul>
        </nav>
    </header>
    <!-- //main-head -->
    <?php parseOrders($orders); ?>
