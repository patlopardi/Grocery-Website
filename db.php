...
//logs out, clearing session variables and sends to index.php
function logout()
{
    $_SESSION = array();
...
//censors card. leaves last 4 digits
...
function parseOrders($orders)
{
    foreach ($orders as $order) {
        ...
        print '<div class="wrap-all-the-things">
            ...
            print '</div><br><p>Order Placed at:&nbsp&nbsp&nbsp ' . $date . '</p></div></div>';
            }
            print '              </div>
                            </div>
                        </div>
