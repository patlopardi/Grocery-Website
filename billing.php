  ...
  <main>
    ...
    <nav class="navbar">
      <div class="logo">
        <div class="logo-left">
          <a href="index.php" class="logo">
            <img
              id="header-img"
              src="assets/birdfeeder-logo.png"
      ...
      <ul class="nav-links" id="linkChange">
        <li class="link">
          <a href="profile.php" class="profile-logo-float">
            <img src="assets/profile.png" />
          </a>
        </li>
        <li class="link">
          <a href=<?php echo($checkoutDirect); ?>>
    ...
    <header class="main-head">
      <nav class="head-nav">
        <ul class="menu">
          ...
          <li>
            <a href="billing.php">
              <img src="assets/billing.png" alt="" /><span
                >Billing Info</span
              ></a
            >
          </li>
          ...
          <li>
            <a href="#">
              <img
                class="logout"
                style="margin-left: 22px; margin-right:38px;"
